...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.TAZAS) {
      return <ProductCups>[
        ProductCups(
          productTitle: "Taza original",
          productDescription: "Taza de tamaño estandar.",
          productImage:
              'https://http2.mlstatic.com/caja-de-tazas-sublimacion-extra-blanca-de-11-onz-36-pzas-D_NQ_NP_664398-MLM27479309647_062018-F.jpg',
          productColor: ProductColor.BLUE,
          productAmount: 0,
        ),
        ProductCups(
          productTitle: 'Taza de estrellas',
          productDescription: 'Taza de tamaño estandar con estrellas',
          productImage:
              'https://pendulo.com/images/galeria/1738-8142290276214.01.jpg',
          productColor: ProductColor.BLUE,
          productAmount: 0,
        ),
        ProductCups(
          productTitle: 'Taza para capuccino',
          productDescription: 'Taza de 190ml',
          productImage:
              'https://www.complementosdelcafe.com/1774-thickbox_default/acme-taza-roja-cappuccino-190ml.jpg',
          productColor: ProductColor.RED,
          productAmount: 0,
        ),
        ProductCups(
          productTitle: 'Taza Charlie Brown',
          productDescription:
              'Taza de tamaño estandar con estampado de Charlie Brown',
          productImage:
              'https://www.sanborns.com.mx/imagenes-sanborns-ii/1200/763795374755.jpg',
          productColor: ProductColor.BLUE,
          productAmount: 0,
        ),
        ProductCups(
          productTitle: 'Taza Batman',
          productDescription: 'Taza de 500ml',
          productImage:
              'https://gameplanet-53f8.kxcdn.com/media/catalog/product/cache/4/image/9df78eab33525d08d6e5fb8d27136e95/t/a/taza-batman-funko.jpg',
          productColor: ProductColor.BLUE,
          productAmount: 0,
        ),
      ];
